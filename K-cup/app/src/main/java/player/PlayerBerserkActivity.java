...
public class PlayerBerserkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_player_berserk);
    ...
    private void goToNextRule() {
        ...
        if (SharedPreferenceUtils.getRule(getApplicationContext(), SharedPreferenceUtils.PREFS_RULE).get(0).getType()
            ...
            Intent k = new Intent(PlayerBerserkActivity.this, NoNeedPlayerActivity.class);
            ...
            Intent k = new Intent(PlayerBerserkActivity.this, ChallengeActivity.class);
            k.putExtra(GameUtils.EXTRA_ANIMATION_BEGIN, true);
            startActivity(k);
        } else if ((SharedPreferenceUtils.getRule(getApplicationContext(), SharedPreferenceUtils.PREFS_RULE).get(0).getType()
                .equals(GameUtils.Type.CHOICE.toString()))) {
            Intent k = new Intent(PlayerBerserkActivity.this, ChoiceActivity.class);
            k.putExtra(GameUtils.EXTRA_ANIMATION_BEGIN, true);
            startActivity(k);
        }
        ...
        if (getIntent() != null) {
            ...
            if (b != null) {
                ...
                if (!TextUtils.isEmpty(extra)) {
                    ...
                    List<Rule> ruleList = GameUtils.createBerserkGame(getApplicationContext(), extra);
